if Debug then Debug.beginFile "MultiOptionDialog" end
OnInit.module("MultiOptionDialog", function(require)
    --[[
    MultiOptionDialog v1.1 by Insanity_AI
    ------------------------------------------------------------------------------
    ...
    Requires:
        ...
        DialogQueue - https://www.hiveworkshop.com/threads/lua-dialog-queue.346286/
